...
const Welcome: React.FC<WelcomeProps> = ({ course }) => (
  <>
    ...
    <p>
      ...
      (hopefully) easy to understand if read chronologically, however, they are
      not exhaustive and do not include extensive examples and applications.
    </p>
    <p>
      Keep in mind that course contents might change over time. If you spot any
      errors, feel free to contribute to the notes by submitting a pull request
      on the{" "}

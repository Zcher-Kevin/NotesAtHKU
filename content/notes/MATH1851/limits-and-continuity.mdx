...
<Block variant="secondary" title="Condition for limit to exist">
...
<div className="w-full flex gap-2 flex-wrap lg:flex-nowrap items-center">
<div >
...
<div className="w-72">![](/img/MATH1851/lim3.jpg)</div>
</div>
...
<Block variant="primary" title="Continuity">
...
<Block variant="knowledge" title="Continuity properties">
For $f,g$ continuous at $c$, the following are also continuous at $c$:

    1. $f \pm g$
    2. $kf$
    3. $fg$
    4. $\frac{f}{g}$, given that $g(c)\ne 0$
</Block>


<Block variant="secondary" title="Intermediate value theorem (IVT)">
...
<Block variant="primary" title="Indeterminate forms">
...
```
Note that $\infty + \infty = \infty$. Related: [L'Hopital's rule](derivatives#l'hopital's-rule)
</Block>


<Block variant="secondary" title="Using the limit laws">
For functions $f,g$ and using $\mathop {\lim }\limits_{x \to a}=\bigcirc$ for simpler notation:
    ...
    6. $\bigcirc(\frac{f}{g})=\frac{\bigcirc f}{\bigcirc g},    \text{given that }\bigcirc g\ne 0$. *This strict condition prevents indeterminate forms.*
We can use these laws to break a limit into separate limits, and compute that way. Also note that:

    7. $\bigcirc f(g)=f(\bigcirc g),    $given that $f$ is **continuous** at $\bigcirc g$
</Block>


<Block variant="secondary" title="Limit of a polynomial">
...
<Block variant="knowledge" title="Techniques to compute limits">
...
<Block variant="knowledge" title="Limits of composite functions">
...
<Block variant="knowledge" title="Limits of square roots">
...
<Block variant="secondary" title="The squeeze / sandwich theorem">
...
<Block variant="knowledge" title="Determining infinite limits">
...
<HLayout>
<Block variant="example" title="Infinite limit exists">
```math
...
<Block variant="example" title="Infinite limit doesn't exist">
```math
...
<Block variant="secondary" title="Infinity operations">
...
<Block variant="knowledge" title="Determining limits of infinity">
...
<Block variant="secondary" title="Determining limits of infinity of polynomials">
...
<Block variant="example" title="Indeterminate forms by substitution of infinity">

Substituting $\infty$ into the function gives $\infty-\infty-\infty$, which is indeterminate. Hence, we must factorize it.
```math
\begin{aligned}\lim_{x\to\infty}2x^4-x^2-8x & =\lim_{x\to\infty}[x^4(2-\frac{1}{x^2}-\frac{8}{x^3})] \\
& =\infty\times 2                                        \\
& =\infty
\end{aligned}
```
...
<Block variant="example" title="Factor polynomials limit to infinity">
...
<Block variant="primary" title="Vertical asymptotes">
...
<Block variant="primary" title="Horizontal asymptotes">
...
Related: [Graphing functions](derivatives#determining-shape-of-graph)
...
<BlockSep />
[Example](solve-recurrence-relation-with-substitution-method)
...
4. Falling factorial: $n^{(k)} = n(n-1)(n-2)\cdots(n-k+1)=\frac{n!}{(n-k)!}$
...
<BlockSep />
[Example](question-examples#proving-with-mathematical-induction)

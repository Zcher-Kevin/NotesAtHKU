...
<div className="flex items-center justify-center gap-4"><div className="w-52">![graph](./img/graph.png)</div> $\left[\begin{matrix}0 & 1 & 0 \\1 & 0 & 1 \\0 & 1 & 0 \\\end{matrix}\right]$</div>
...
<div className="flex items-center justify-center gap-4"><div className="w-52">![graph](./img/graph.png)</div> $[[2],[1,3],[2]]$</div>
...
<div className="flex items-center justify-center gap-4"><div className="w-52">![graph](./img/graph.png)</div> $[(0,1),(1,2)]</div>

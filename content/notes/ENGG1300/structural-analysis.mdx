...
<Inline><div className="max-w-80">![](././img/quadtruss.png)</div>
<div className="max-w-24">![](././img/tritruss.png)</div></Inline>
...
<BlockSep />
<HLayout>
<div className="max-w-80">![](././img/zero2.jpg)</div>
<div className="max-w-80">![](././img/zero3.jpg)</div>
</HLayout>
</Block>

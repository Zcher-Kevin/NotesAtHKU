...
<Block variant="primary" title="Types of e-commerce">
Business, Customers
...
<Block variant="knowledge" title="O2O - Online to Offline / OMO - Online Merged Offline">
...
Platforms are sensitive to the [**network effect**](digital-economy#types-of-network-goods). The more users on the platform, the more valuable it is. This allows the platform to have a significant advantage, even when innovative entrants have better products.


<Block variant="knowledge" title="Increase switching costs">

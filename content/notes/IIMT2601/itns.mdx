...
<Block variant="primary" title="Digital Natives vs. Immigrants">
...
<Block variant="primary" title="Information Systems & Technologies (IS & IT)">
...
<Block variant="primary" title="Data vs. Information">

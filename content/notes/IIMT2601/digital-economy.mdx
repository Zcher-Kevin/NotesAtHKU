...
<Block variant="primary" title="Types of digital economy">
...
<Block variant="primary" title="Digital products">
...
<Block variant="primary" title="Types of network goods">

- **Homogeneous**: Users perform the same action. (e.g. Whatsapp)
- **Two-side**: Distinct user groups (e.g. Carousell)

The types of goods are usually [**platforms**](e-commerce#platform-economy), and it's the role of the **platform owner** to design and manage the playfield.
</Block>

...
<Block variant="theorem" title="Moore's Law">
...
<Block variant="definition" title="ISP">
...
<Block variant="definition" title="NAP">
...
<Block variant="definition" title="Bandwidth">
...
<Block variant="definition" title="Protocol">
...
<Block variant="theorem" title="Packet switching">
...
<Block variant="definition" title="Domain Name">
A human-readable name for an IP address.
</Block>


<Block variant="definition" title="Domain Name System (DNS)">
...
<Block variant="definition" title="Open source software (OSS)">
...
<Block variant="definition" title="Total cost of ownership (TCO)">
...
<Block variant="definition" title="LAMP stack">
...
<Block variant="definition" title="Cloud computing">
Data sent to shared computing resources over the internet, and sent back when completed.
</Block>


<Block variant="theorem" title="Cloud computing models">
...
<Block variant="definition" title="Internet of things (IoT)">

...
```mermaid
graph LR
    A[Start: Decision - Produce Suds-Away?] -->|Do Not Produce| B[Outcome: $0 No Loss or Gain]
    A -->|Produce Without Test| C[Market Outcome]

    C -->|Strong Market 30%| D[Profit: +$18M]
    C -->|Weak Market 70%| E[Loss: -$8M]

    A -->|Conduct Market Survey $2.4M| F[Survey Outcome]

    F -->|Positive Test| G[Decision - Produce Suds-Away?]
    G -->|Do Not Produce| H[Outcome: -$2.4M Survey Cost]
    G -->|Produce| I[Market Outcome After Positive Test]
    I -->|Strong Market 90%| J[Profit: +$18M - $2.4M]
    I -->|Weak Market 10%| K[Loss: -$8M - $2.4M]

    F -->|Negative Test| L[Decision - Produce Suds-Away?]
    L -->|Do Not Produce| M[Outcome: -$2.4M Survey Cost]
    L -->|Produce| N[Market Outcome After Negative Test]
    N -->|Strong Market 20%| O[Profit: +$18M - $2.4M]
    N -->|Weak Market 80%| P[Loss: -$8M - $2.4M]
```
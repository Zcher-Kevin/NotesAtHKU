...
!!! tip "Production runs"
    ...
    * **Long run** is the period over which **all inputs are variable**. 
        * $TR=TC \to $ no economic profit.
        * Profit maximization at $ATC = AVC = MC$ as no fixed cost.
...
!!! info "Price control on monopoly"
    ...
    Special points:
    * $P @ D=MC \implies$ Profit maximizing, no dwl, socially optimal
    * $P @ D=AC \implies$ Zero profit, DWL triangle under $x(I)$ and above MC. 

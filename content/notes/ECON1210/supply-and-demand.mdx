...
!!! info "Normal and inferior goods"

    $P \uparrow I \downarrow \rightarrow$ demand for normal goods $\uparrow$.

    - **Normal goods**: $I \uparrow \rightarrow Q_d \uparrow$.
    - **Inferior goods**: $I \uparrow \rightarrow Q_d \downarrow$.
...
!!! note "Complements"
    ...
    Two goods are complement if $P_{c1} \downarrow \rightarrow D_{c2} \uparrow$.

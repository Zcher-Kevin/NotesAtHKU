...
| <u>Expo</u>nential | <u>Ber</u>noulli | <u>B</u>inomial | <u>Geo</u>metric | <u>N</u>egative <u>B</u>inomial | <u>Po</u>ssion |
...
The <u>N</u>ormal distribution is given by the following formula (which you don't have to memorize):
```math

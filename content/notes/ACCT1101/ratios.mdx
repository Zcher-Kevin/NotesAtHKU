...
| **Ratio** | **Formula** | **Interpretation** |
| :--- | ---: | :--- |
| Net Profit Margin | Income : Revenue (profit:) | Every **revenue dollar** generates $<u>\hspace{1em</u>}$ **profit**. |
...
| Return on Equity | Net Income : Average Equity | Every **equity dollar** generates $<u>\hspace{1em</u>}$ **profit**. |

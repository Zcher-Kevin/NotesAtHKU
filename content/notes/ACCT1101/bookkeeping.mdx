...
R,E,D all feed into Equity. This will be further explored in [Financial Statements](financial-statements).
</Block>
...
<JournalEntry entries={[{ debit: [['Accounts receivable', 10]], credit: [['Allowance for doubtful accounts', 1]] }]} />
...
[Learn more](#reporting-and-intepreting-stockholders-equity) about Stockholder's Equity.
...
<span className="text-center w-full block text-sm">Dr - Cr</span>

<span className="text-center w-full text-lg block">**DEA LER**</span>

<span className="text-center w-full block">Dividend, Expense, Asset - Liability, Equity, Revenue</span>
...
A record of a transaction in the journal <u>during the accounting period</u>. The following is the format:
    ...
    entries={[
        {
            ...
            note: "To record the issuance of common stock for cash"
        }
    ]}
/>
</ACCTExample>
...
<div className="mx-auto w-96">![t-account](/img/ACCT1101/t.png)</div>
...
The shares bought back by the company from the public. This is a [contra](#contra-accounts)-equity account, as can be thought of as being opposite to common stock.
</Block>
...
When a stock is sold. Other than recording the stock issurance, we also need to record the <ColorBox color='pink'>**additional paid-in capital**</ColorBox> (APC) when the stock is sold for more than the [par value](#par-vs-market-value).
...
<JournalEntry
    entries={[
        {
            debit: [['Cash', 16]],
            credit: [['Common Stock', 2], ['Additional Paid-in Capital', 14]]
        }
    ]}
/>
...
<JournalEntry
    entries={[
        {
            debit: [['Retained earnings', 2]],
            credit: [['Dividends payable', 2]]
        }
    ]}
/>
...
<JournalEntry
    entries={[
        {
            debit: [['Cash', 13], ['Additional paid-in capital', 1]],
            credit: [['Treasury stock', 14]]
        }
    ]}
/>
...
These concepts make up the [statement of stockholder's equity](financial-statements#statement-of-stockholders-equity).
...
<div className="flex flex-wrap">
    <div className="w-full md:w-1/2 px-2">
        <p className="font-bold">Perpetual System:</p>
        <p className="mt-4">When we restock our inventory:</p>
        <JournalEntry
            entries={[
                {
                    date: "Jan 1, 2023",
                    debit: [[<ColorBox color='lime'>Inventory</ColorBox>, "1"]],
                    credit: [["Cash", "1"]],
                },
            ]}
        />
        <p className="mt-4">When we make a sale:</p>
        <JournalEntry
            entries={[
                {
                    date: "Jan 2, 2023",
                    debit: [["Cash", "2"]],
                    credit: [["Sales Revenue", "2"]],
                    note: "To record the sale of goods",
                },
                {
                    date: "Jan 2, 2023",
                    debit: [["Cost of Goods Sold", <ColorBox color='yellow'>1</ColorBox>]],
                    credit: [[<ColorBox color='lime'>Inventory</ColorBox>, "1"]],
                    note: "Update real-time",
                },
            ]}
        />
    </div>
    <div className="w-full md:w-1/2 px-2">
        <p className="font-bold">Periodic System:</p>
        <p className="mt-4">When we restock our inventory:</p>
        <JournalEntry
            entries={[
                {
                    date: "Jan 1, 2023",
                    debit: [[<ColorBox color='lime'>Purchases</ColorBox>, "1"]],
                    credit: [["Cash", "1"]],
                },
            ]}
        />
        ...
        />
        <p className="mt-4">At the end of the period:</p>
        <JournalEntry
            entries={[
                {
                    date: "Dec 31, 2023",
                    debit: [["Inventory", "1"]],
                    credit: [[<ColorBox color='lime'>Purchases</ColorBox>, "1"]],
                    note: "Update inventory restock first",
                },
                {
                    date: "Dec 31, 2023",
                    debit: [["Cost of Goods Sold", <ColorBox color='yellow'>1</ColorBox>]],
                    credit: [["Inventory", "1"]],
                    note: "Update COGS after"
                },
            ]}
        />
    </div>
...
The difference between the COGS and the revenue will reflect the profit accordingly when we produce the [income statement](financial-statements#income-statement).
...
Reflects the changes in inventory during an accounting period, with the total cost of good sold depending on [cost flow assumptions](#cost-flow-assumptions).
</Block>
...
| Jan 3, 2023 | Sale                    | (150)    | /         | (<ColorBox color='yellow'>?</ColorBox>) $\leftarrow$ *COGS* |
|             | Ending inventory        | 150      | /         | \$500 - ?                                |

*<ColorBox color='yellow'>?</ColorBox> COGS depends on the [cost flow assumptions](#cost-flow-assumptions).*
...
1. Record [**depreciation** expense](trial-balances#ecording-depreciation-expense) of the item for this period
...
<JournalEntry
    entries={[
        {
            debit: [['Depreciation expense', 1.2]],
            credit: [['Accumulated depreciation', 1.2]],
            date: '1.',
            note: 'Depreciation expense for the period'
        },
        {
            debit: [['Cash', 11], ['Accumulated depreciation', 20.4]],
            credit: [['Equipment', 30], ['Gain on sale of assets', 1.4]],
            date: '2.',
            note: 'Sale of equipment'
        }
    ]}
/>
...
- Original cost: \$1000
- Less: Accumulated depreciation: $\frac{1000}{25}\times 2= $\$$80$
...
<JournalEntry
    entries={[
        {
            debit: [['Income tax expense', 300]],
            credit: [['Income tax payable', 300]]
        }
    ]}
/>

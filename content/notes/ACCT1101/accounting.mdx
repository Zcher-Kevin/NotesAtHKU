...
This mean that __revenue is recognized when it is **earned**__,\\and __expenses are recognized when they are **incurred**__, regardless of when cash is received or paid.
</Block>



<Block variant="knowledge" title="Cash basis of accounting">
This is a method of accounting where __revenue is recognized when cash is received__ and __expenses are recognized when cash is paid__.
</Block>

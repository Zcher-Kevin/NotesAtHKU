...
- *Record (During the period)* [Record](bookkeeping)
    1. Identify transactions [Identify](bookkeeping#identifying-transactions)
    2. Prepare journal entries [Prepare](bookkeeping#prepare-journal-entries)
    3. Post to general ledger [Post](bookkeeping#post-to-general-ledger)
- *Trial (At the end of the period)* [Trial](trial-balances)
    1. Unadjusted trial balance
    2. Post adjusting entries [Post Adjust](trial-balances#post-adjusting-entries)
    3. Adjusted trial balance
- *Post*
    1. Create finanical statements [Financial Statements](financial-statements)
    2. Post closing entries [Closing Entries](closing-entries)

FIX-ADD: arrows

During the period, the cycle records all your transactions accordingly by the [Cash Basis of Accounting](#cash-basis-of-accounting). At the end of a period, we test for errors and respect our transactions by the [Accural Method of Accounting](#thm-accrual_basis). Finally, we create finanical statements that will be published, so that stakeholders can make decisions based on the financial information.
...
This mean that <u>revenue is recognized when it is **earned**</u>,
and <u>expenses are recognized when they are **incurred**</u>, regardless of when cash is received or paid.

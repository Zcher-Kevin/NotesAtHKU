...
In the account cycle, after preparing an unadjusted trial balance, we make adjustments to respect the [Accrual Basis of Accounting](accounting#accural-method-of-accounting) for different types of expense and revenues.

This adjustment is necessary when the two sides of a transaction (remember [double-sided nature](bookkeeping#double-entry-bookkeeping)) happens in a __different accounting period__. (So no adjustments necessary if same period)
</Block>
...
This moves the transaction back to the [**temporary accounts**](closing-entries#categorizing-accounts-as-temporary-/-permanent).
</Block>
...
<JournalEntry
    entries={[
        {
            date: "XXX 31, 2024",
            debit: [["Utility expense", "$1"]],
            credit: [["Prepaid expense", "$1"]],
        },
    ]}
/>
</ACCTExample>
    ...
    entries={[
        {
            date: "Jan 31, 2023",
            debit: [["Utility expense", "$1"]],
            credit: [["Accrued expense", "$1"]],
            note: "(Water bills accrued)",
        },
        {
            date: "Feb 28, 2023",
            debit: [["Utility expense", "$1"]],
...
<JournalEntry
    entries={[
        {
            date: "Mar 31, 2023",
            debit: [["Utility expense", "$4"]],
            credit: [["Cash", "$4"]],
            note: "(Water bills payment)",
        },
        {
            date: "Mar 31, 2023",
            debit: [["Accrued expense", "$2"]],
            credit: [["Utility expense", "$2"]],
            note: "(Release accrued expense)",
        },
    ]}
/>
...
<JournalEntry
    entries={[
        {
            date: "Dec 31, 2023",
            debit: [["Depreciation expense", 12]],
            credit: [["Accumulated depreciation", 12]],
        },
    ]}
/>

Accumulated depreciation is a [**contra asset**](bookkeeping#contra-accounts), as it has a normal balance opposite to the asset. We record it like the following in the balance sheet:
...
Related: [Asset disposal](bookkeeping#reporting-asset-disposal)
...
When considering the net sales revenue, we need to recognize some of the following deductions. They are not expenses, but a [**contra revenue**](bookkeeping#contra-accounts) of **credit sales revenue**.
...
These discounts **should not include** the [capitalized](bookkeeping#reporting-maintenance-and-improvements-of-equipment) costs.
...
We simply present as a [**contra revenue**](bookkeeping#contra-accounts) of **sales revenue**.
...
An [**contra account**](bookkeeping#contra-accounts) for the **accounts receivable** to estimate the amount of money that will not be paid.
</Block>
...
We record an **estimated**bad debt expense at the end of the period of the credit sales as an adjusting entry.
    ...
    entries={[
        {
            date: "Dec 31, 2023",
            debit: [["Cash", 12]],
            credit: [["Allowance for doubtful accounts", 12]],
        },
    ]}
/>
...
<Block variant="knowledge" title="Presenting in income statement">
We present the allowance of doubtful accounts as a [**contra asset**](bookkeeping#contra-accounts) of **accounts receivable**.
